...
acute_pancreatitis = {
    ...
    "symptoms" : ['Severe Pain in the abdomen', 'Feeling or being sick', 'Diarrhoea', 'Fever'], "treatment" : "Hospital admission over several days, Intravenous fluids, and Pain relief"
}
...
dengue = {
    ...
    "symptoms[]" : ['High Temperature', 'Severe Headaches', 'Joint Pain', 'Widespread red rash'],"treatment" : "Taking Paracetamol, drinking plenty of fluids and getting plenty of rest"
}
...
disentry = {
    ...
    "symptoms[]" : ['Painful stomach cramps', 'Feeling sick or vomiting', 'High temperature'], "treatment" : "Dysentry usually gets better after 7 days, but it's important to drink fluids regularly and take painkillers to relieve the pain and fever"
}

dead = {
    "name" : "Dead", 
    "description" : "The Patient is dead mate, they ain't coming back from this one", 
    "symptoms[]" : ['Patient has no pulse', 'Patient is not breathing', 'patient is non-responsive'], "treatment" : "Nothing short of a miracle will bring them back from this one"
}
...
frostbite = {
    "name" : "Frostbite", 
    "description" : "Frostbite is damage to skin and tissue caused by exposure to freezing temperatures – typically any temperature below -0.55C (31F).", 
